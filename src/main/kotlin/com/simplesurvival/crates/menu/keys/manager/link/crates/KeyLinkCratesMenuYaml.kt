...
object KeyLinkCratesMenuYaml : YamlBuilder<SimpleCrates>(
    SimpleCrates.plugin,
    "menus/key/manager/key_link_crates.yml"
)
{
    ...
    var crateItem: SimpleItemBuilder = SimpleItemBuilder(Material.CHEST)
        ...
        .withLore(
            ...
            "&7${format("this crate to the key.")}",
            "",
            "&6${format("Left-click:")} &e${format("Select Crate.")}"
        )
